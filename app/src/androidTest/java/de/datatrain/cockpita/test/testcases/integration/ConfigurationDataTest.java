package de.datatrain.cockpita.test.testcases.integration;
...
public class ConfigurationDataTest {
    ...
    private static String GOOD_URL = "https://mobile-a71f9a2af.hana.ondemand.com/";
    ...
    private static String GOOD_DISC_SVC_DFLT =
            ...
            + "    \"port\": 443,\n"
            + "    \"protocol\": \"https\",\n"
            + "    \"appID\": \"de.datatrain.cockpitnative\"\n"
            + "}\n";
