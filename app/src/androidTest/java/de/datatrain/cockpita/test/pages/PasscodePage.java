...
import de.datatrain.cockpita.test.core.AbstractPasscodePage;
import de.datatrain.cockpita.test.core.UIElements;
import de.datatrain.cockpita.test.core.Utils;
import de.datatrain.cockpita.test.core.WizardDevice;
    ...
    public class EnterPasscodePage extends AbstractPasscodePage {
        ...
        public void enterPasscode(String passcode) {
            ...
            if (WizardDevice.fromBackground) {
                try {
                    new UiObject(new UiSelector().resourceId("de.datatrain.cockpita:id/passcode_field")).setText(passcode);
