...
import de.datatrain.cockpita.logon.ActivationActionHandlerImpl.Companion.DISCOVERY_SVC_EMAIL
    ...
    private fun promptForProviderInput() {
        Intent(activity, ActivationActivity::class.java).also { inputRequest: Intent ->
            val activationSettings = ActivationSettings().apply {
                ...
                actionHandler = "de.datatrain.cockpita.logon.ActivationActionHandlerImpl"
