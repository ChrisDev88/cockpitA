...
class ClientPolicyManager(private var sapWizardApplication: SAPWizardApplication) {

    private var secureStoreManager = sapWizardApplication.secureStoreManager
            ...
            if (isLogPolicyEnabled) {
                AppLifecycleCallbackHandler.getInstance().activity?.runOnUiThread {
                    ...
                    Toast.makeText(activity,
                        String.format(activity!!.getString(R.string.log_level_changed), finalLogLevel!!.levelStr),
                ...
                AppLifecycleCallbackHandler.getInstance().activity?.runOnUiThread {
                    ...
                    Toast.makeText(
                        activity,
                        String.format(activity!!.getString(R.string.log_level_default), finalLogLevel!!.levelStr),
                        Toast.LENGTH_SHORT).show()
                }
            }
        }
    ...
    companion object {
        ...
        private val PASSCODE_POLICY_DEFAULT_ENABLED = "passwordPolicyDefaultPasswordAllowed"
